...
struct tag_mmu_info           kernel_sec_mmu_reg_dump;
...
static void kernel_sec_get_mmu_reg_dump(struct tag_mmu_info *mmu_info)
{
...
void kernel_sec_save_final_context(void)
{
    ...
    kernel_sec_get_mmu_reg_dump(&kernel_sec_mmu_reg_dump);
...
#if defined(CONFIG_MACH_EUROPA) || defined(CONFIG_MACH_CALLISTO) || defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_LUCAS) || defined(CONFIG_MACH_VASTO)
...
#if defined(CONFIG_DEBUG_KERNEL_SEC)
        local_irq_disable();
        local_fiq_disable();
