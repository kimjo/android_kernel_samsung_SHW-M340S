...
SubChInfoTypeDB* DMBDrv_GetFICDMB(int nSubChCnt)
{
	...
	memset((void*)&gDMBSubChInfo, 0, sizeof(gDMBSubChInfo)); /* parasoft-suppress MISRA2008-0_1_2_t "False Alarm - intended code" */
...
SubChInfoTypeDB* DMBDrv_GetFICDAB(int nSubChCnt)
{
	...
	memset((void*)&gDABSubChInfo, 0, sizeof(gDABSubChInfo)); /* parasoft-suppress MISRA2008-0_1_2_t "False Alarm - intended code" */
