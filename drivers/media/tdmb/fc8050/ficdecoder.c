...
void SubChannelOrganizationPrn(int subChId)
{
	...
	memset(&didp, 0, sizeof(didp)); /* parasoft-suppress MISRA2008-0_1_2_t "False Alarm - intended code" */
...
#if 1
	memset(gEsbInfo, 0, sizeof(esbInfo_t) * MAX_ESB_NUM); /* parasoft-suppress MISRA2008-0_1_2_t "False Alarm - intended code" */
	memset(gSvcInfo,0, sizeof(svcInfo_t) * MAX_SVC_NUM); /* parasoft-suppress MISRA2008-0_1_2_t "False Alarm - intended code" */
	memset(gScInfo,0, sizeof(scInfo_t) * MAX_SC_NUM); /* parasoft-suppress MISRA2008-0_1_2_t "False Alarm - intended code" */
	memset(subChInfo,0, sizeof(subChInfo_t) * MAX_SUBCH_NUM); /* parasoft-suppress MISRA2008-0_1_2_t "False Alarm - intended code" */
#endif
