...
#define T48_CALCFG_TA     0x52//0x70//0x50
#define T48_CALCFG        0x40//0x60//0x40

#if defined(U1_EUR_TARGET)
static bool gbfilter;
#endif

#define CONFIG_TARGET_LOCALE_KOR
...
*/			
	   ...
	   else if(state >= 2)
	   {
		value = 10; //basefreq
		write_mem(copy_data, obj_address+3, 1, &value);
		value = 0; //1; 20120202 //secondmf
		write_mem(copy_data, obj_address+8, 1, &value);
		value = 0;//2; 20120202  //thirdmf
		write_mem(copy_data, obj_address+9, 1, &value);
...
#ifdef QT_FIRMUP_ENABLE
{
	...
	noise_median.t48_movfilter_for_mferr = 80;  //0  201120202
#endif
