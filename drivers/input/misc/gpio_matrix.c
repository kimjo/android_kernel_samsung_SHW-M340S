...
#define FEATURE_SIDE_KEY_SLEEP
#endif

#ifdef FEATURE_SIDE_KEY_SLEEP
...
#define GPIO_KEY_SCAN   31
#define GPIO_KEY_SCAN1   32

#define GPIO_VOLUME_UPDOWN   39
...
#if defined(FEATURE_SIDE_KEY_SLEEP)
...
static enum hrtimer_restart gpio_keypad_timer_func(struct hrtimer *timer)
{
	...
	if(long_key_state == LONG_KEY_CHECK_ACTIVE)
	{
		if(key_press_count++ > MAX_KEY_PRESS_COUNT)
		{
			...
			if(!gpio_get_value(GPIO_VOLUME_UPDOWN))
			{
				irq = gpio_to_irq(GPIO_VOLUME_UPDOWN);    			
